...
1. Die aktuelle RC-Linie ist `1.1.0-rc.1`; `1.0.0` bleibt der ausgelieferte Stable-Stand.
   Offene PRs sind kein ausgelieferter Stand.
...
45. Für den 1.1-RC ausschließlich den bereits geprüften visuellen Forschungsbaum und die bestehenden
    A→B-/RP-/GE-/SL-Verträge bearbeiten. Keine neue Explain Engine, kein Dashboard, kein Project
    Intelligence, kein Optimizer-Ausbau und keine neue Solver-, Folder- oder Datamine-Semantik.
